...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label2->Location = System::Drawing::Point(24, 88);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(246, 20);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Algorithms          Nastya Beynik";
			// 
			// label3
			// 
			...
			this->label3->Text = L"FIle management     Oleg Galysh";
			// 
			// label4
			// 
			...
			this->label4->Size = System::Drawing::Size(247, 20);
			this->label4->TabIndex = 3;
			this->label4->Text = L"Interface          Denis Statsenko";
			// 
			// MyForm3
			// 
			...
			this->MaximumSize = System::Drawing::Size(300, 277);
			this->MinimumSize = System::Drawing::Size(300, 277);
			this->Name = L"MyForm3";
