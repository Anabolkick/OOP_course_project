...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(120, 24);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(108, 20);
			this->label1->TabIndex = 0;
			this->label1->Text = L"Розробники";
			// 
			// label2
			// 
			...
			this->label2->Size = System::Drawing::Size(309, 20);
			this->label2->TabIndex = 1;
			this->label2->Text = L"Алгоритми                  Настя Бейник";
			// 
			// label3
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label3->Location = System::Drawing::Point(8, 144);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(292, 20);
			this->label3->TabIndex = 2;
			this->label3->Text = L"Робота з файлами     Олег Галиш";
			// 
			// label4
			// 
			...
			this->label4->Size = System::Drawing::Size(331, 20);
			this->label4->TabIndex = 3;
			this->label4->Text = L"Інтерфейс                   Денис Стаценко";
			// 
			// label5
			// 
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(204)));
			this->label5->Location = System::Drawing::Point(72, 56);
			...
			this->ClientSize = System::Drawing::Size(347, 246);
