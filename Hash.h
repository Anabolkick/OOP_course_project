...
namespace hash {
	...
	int Hash ::getSaul(string str) {   //сумма всех символов введеніх в строку
	 ...
	 string Hash :: getHash(string PasID, unsigned int lengHash) {//генерация хеша
		 if (lengHash > 3) {
