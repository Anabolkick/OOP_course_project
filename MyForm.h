...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->voteOptions->Items->AddRange(gcnew cli::array< System::Object^  >(amount) {// в 7 строке находитс€ количесво вариантов
				L"Somov Ivan Nikolaevich", L"Sokolenko Maria Dmitrievna",		//если добавили когото или что-то помен€ли в 437 строку добавить им€ кандидата а в 7 изменить количество
